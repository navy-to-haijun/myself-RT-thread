...
/* 选择使用 littleVGL 自带的内存管理还是使用自己自定义的内存管理,
 * 当其值为 0 时,是选择内部自带的,当其值为 1 时,是选择自定义的方式 */
...
/* 定义 Drag 拖拽动作的阈值：代表按住不放拖动 10 个像素以上才认为是一次有效的 Drag 拖拽动作 */
 ...
 *  THEME USAGE
 *================*/
#define LV_THEME_LIVE_UPDATE    1   /*来是否允许在运行状态下切换主题风格的*/
